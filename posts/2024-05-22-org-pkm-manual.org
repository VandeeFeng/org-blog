...
现在我也从 DoomEmacs 转为自己配置了，这是我之前的doomemacs[[https://github.com/VandeeFeng/doomemacs][配置]]，这个手册的配置代码示例是基于 DoomEmacs 的，原生 Emacs 和不使用 ~use-package~ 的需要修改。
...
- 2024-11-12: 从 DoomEmacs 转向原生 Emacs 自己配置。
* Thanks
