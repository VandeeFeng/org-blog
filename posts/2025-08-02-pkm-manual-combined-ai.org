...
笔记的同步就用 GitHub 就好了，笔记的版本管理和备份是很必须的，GitHub 的 commit 对于管理笔记太合适了。如果特别看重隐私或者讨厌 GitHub，可以自托管 [[https://docs.gitea.com/][Gitea]] 或 [[https://about.gitlab.com/install/][GitLab]]。
**** 迭代
...
#+begin_src elisp
;; gptel + org-protocol integration
(require 'org-protocol)
(require 'gptel)

;; Enable org-protocol server
(require 'server)
